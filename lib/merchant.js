...
import {CheckPaymentResponse, CheckTransactionResponse, GenerateAddressResponse, GetPaymentUrlResponse} from "./dto.js";
...
export class MerchantApi extends MerchantApiBase {
  ...
  async checkPayment(request) {
    return new CheckPaymentResponse(await this._makeRequest('sci_confirm_order', request.normalize()))
  }
  ...
  async checkTransaction(request) {
    return new CheckTransactionResponse(await this._makeRequest('sci_confirm_transaction_notification', request.normalize()))
  }
  ...
  async generateAddress(request) {
    return new GenerateAddressResponse(await this._makeRequest('sci_create_order_get_data', request.normalize()))
  }
  ...
  async getPaymentUrl(request) {
    return new GetPaymentUrlResponse(await this._makeRequest('sci_create_order', request.normalize()))
  }
}
